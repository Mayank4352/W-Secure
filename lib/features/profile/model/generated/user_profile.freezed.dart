...
class _$UserProfileImpl implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(name: $name, email: $email, emergencyContact: $emergencyContact, profilePictureUrl: $profilePictureUrl)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, email, emergencyContact, profilePictureUrl);
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      ...
      final String email,
      final String emergencyContact,
      final String profilePictureUrl}) = _$UserProfileImpl;
